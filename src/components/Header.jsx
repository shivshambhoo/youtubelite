...
const Header = () => {
  ...
  //  searchquery handler becially jab serach fild me kuchh type karnege to call hoga 
  const searchQuerHandler = (event) => {
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black">
      ...
      <div className="group flex items-center">
        ...
        onClick={()=>searchQuerHandler("searchButton")}>
          <IoIosSearch className='text-white text-xl' />
        </button>
      ...
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
            <img src='https://xsgames.co/randomusers/assets/avatars/male/76.jpg' />
          </div>
      </div>
